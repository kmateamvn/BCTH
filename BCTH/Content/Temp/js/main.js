...
Modernizr.load({
  ...
  nope: '/Content/Temp/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['/Content/Temp/plugins/fix/ios-fix/ios-orientationchange-fix.js', '/Content/Temp/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
...
$(document).ready(function(){ 	
	...
	if(supr_Options.rtl) {
		...
		$('#bootstrap').attr('href', '/Content/Temp/css/bootstrap/bootstrap.rtl.min.css');
		$('#bootstrap-responsive').attr('href', '/Content/Temp/css/bootstrap/bootstrap-responsive.rtl.min.css');
		$('body').addClass('rtl');
